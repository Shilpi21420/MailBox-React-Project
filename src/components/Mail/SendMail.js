...
export default function SendMail() {
  ...
  const SendMailhandler = async (event) => {
    ...
    try {
      await axios.post(
        `https://mailbox-react-project-default-rtdb.firebaseio.com/${RecevierEmail}/inbox.json`,
        MailDetails
      );
      await axios.post(
        `https://mailbox-react-project-default-rtdb.firebaseio.com/${SenderEmail}/sent.json`,
        MailDetails
      );
